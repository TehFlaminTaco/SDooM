...
public class MapLoader 
{
    ...
    public const int sizeDividor = 1;
    ...
    public bool Load(string mapName)
    {
        ...
        //lumps
        {
            ...
            Log.Error("MapLoader: Load: Could not find map name \"" + mapName + "\"");
            return false;
        ...
        //sectors
        {
            ...
            for (int i = 0, n = 0; i < num; i++)
            {
                short hfloor = (short)((sectors_lump.data[n++] | (short)sectors_lump.data[n++] << 8) + WadLoader.zOff);
                short hceil = (short)((sectors_lump.data[n++] | (short)sectors_lump.data[n++] << 8) + WadLoader.zOff);
